...
class TestHisto(unittest.TestCase):         
    ...
    def test_default(self):
        ...
        try:
            ...
            display_stats([path+file4, path+file3], ax, mnn = 4, deg = 2, 
                          ...
                          node_labels = False, show_planes = True, edge_cmap = cm.Greys, node_cmap = cm.Greens, show_legend = False)
            plt.close(fig)
        except:
            self.fail("....") 
    ...
    def test_closeness(self):
        ...
        try:
            fig = plt.Figure()
            ax = fig.add_subplot(111, projection='3d')
            display_stats([path+file4, path+file3], ax, mnn = None, deg = 2, 
